        ...
        <section id="content">
          <section class="vbox">
            <section class="scrollable padder">
              ...
              <div class="row">
                <div class="col-sm-6">
                  <form id="wizardform" method="get" action="${pageContext.request.contextPath }/jsp/index.jsp">
...
<script src="${pageContext.request.contextPath }/js/wizard/jquery.bootstrap.wizard.js"></script>
<script src="${pageContext.request.contextPath }/js/wizard/demo.js"></script>
