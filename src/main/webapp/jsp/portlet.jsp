              ...
              <section class="panel panel-success portlet-item">
                ...
                <ul class="list-group alt">
                  <li class="list-group-item">
                    <div class="media">
                      <span class="pull-left thumb-sm"><img src="${pageContext.request.contextPath }/images/a1.png" alt="..." class="img-circle"></span>
                  ...
                  <li class="list-group-item">
                    <div class="media">
                      <span class="pull-left thumb-sm"><img src="${pageContext.request.contextPath }/images/a2.png" alt="..." class="img-circle"></span>
                  ...
                  <li class="list-group-item">
                    <div class="media">
                      <span class="pull-left thumb-sm"><img src="${pageContext.request.contextPath }/images/a3.png" alt="..." class="img-circle"></span>
                  ...
                  <li class="list-group-item">
                    <div class="media">
                      <span class="pull-left thumb-sm"><img src="${pageContext.request.contextPath }/images/a4.png" alt="..." class="img-circle"></span>
