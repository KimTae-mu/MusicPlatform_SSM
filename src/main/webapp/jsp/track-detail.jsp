              ...
              <div class="row">
                <div class="col-sm-8">
                  <div class="panel wrapper-lg">
                    <div class="row">
                      <div class="col-sm-5">
                        <img src="${pageContext.request.contextPath }/images/m10.jpg" class="img-full m-b">
                      </div>
                      <div class="col-sm-7">
                    ...
                    <section class="comment-list block">
                      <article id="comment-id-1" class="comment-item">
                        <a class="pull-left thumb-sm">
                          <img src="${pageContext.request.contextPath }/images/a0.png" class="img-circle">                        </a>
                      ...
                      <article id="comment-id-2" class="comment-item comment-reply">
                        <a class="pull-left thumb-sm">
                          <img src="${pageContext.request.contextPath }/images/a1.png" class="img-circle">                        </a>
                        <section class="comment-body m-b">
                          <header>
                            <a href="#"><strong>John smith</strong></a>
                      ...
                      <article id="comment-id-2" class="comment-item">
                        <a class="pull-left thumb-sm">
                          <img src="${pageContext.request.contextPath }/images/a2.png" class="img-circle">                        </a>
                        <section class="comment-body m-b">
                          <header>
                            <a href="#"><strong>John smith</strong></a>
                            <label class="label bg-dark m-l-xs">Admin</label> 
                    ...
                    <div class="panel-body">
                      <article class="media">
                        <a href="#" class="pull-left thumb-md m-t-xs">
                          <img src="${pageContext.request.contextPath }/images/m18.jpg">
                        </a>
                      ...
                      <article class="media">
                        <a href="#" class="pull-left thumb-md m-t-xs">
                          <img src="${pageContext.request.contextPath }/images/m19.jpg">
                        </a>
                        <div class="media-body">                        
                      ...
                      <article class="media">
                        <a href="#" class="pull-left thumb-md m-t-xs">
                          <img src="${pageContext.request.contextPath }/images/m20.jpg">
                        </a>
                        <div class="media-body">                        
                      ...
                      <article class="media">
                        <a href="#" class="pull-left thumb-md m-t-xs">
                          <img src="${pageContext.request.contextPath }/images/m21.jpg">
                        </a>
                        <div class="media-body">                        
                      ...
                      <article class="media">
                        <a href="#" class="pull-left thumb-md m-t-xs">
                          <img src="${pageContext.request.contextPath }/images/m22.jpg">
                        </a>
                        <div class="media-body">                        
