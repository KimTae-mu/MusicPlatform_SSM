                      ...
                      <div class="wrapper">
                        <div class="text-center m-b m-t">
                          <a href="#" class="thumb-lg">
                            <img src="${pageContext.request.contextPath }/images/a0.png" class="img-circle">
                          </a>
                          <div>
                      ...
                      <div class="tab-content">
                        <div class="tab-pane active" id="activity">
                          <ul class="list-group no-radius m-b-none m-t-n-xxs list-group-lg no-border">
                            ...
                            <li class="list-group-item">
                              <a href="#" class="thumb-sm pull-left m-r-sm">
                                <img src="${pageContext.request.contextPath }/images/a1.png" class="img-circle">
                              </a>
                              <a href="#" class="clear">
                            ...
                            <li class="list-group-item">
                              <a href="#" class="thumb-sm pull-left m-r-sm">
                                <img src="${pageContext.request.contextPath }/images/a2.png" class="img-circle">
                              </a>
                              <a href="#" class="clear">
                            ...
                            <li class="list-group-item">
                              <a href="#" class="thumb-sm pull-left m-r-sm">
                                <img src="${pageContext.request.contextPath }/images/a3.png" class="img-circle">
                              </a>
                              <a href="#" class="clear">
                            ...
                            <li class="list-group-item">
                              <a href="#" class="thumb-sm pull-left m-r-sm">
                                <img src="${pageContext.request.contextPath }/images/a4.png" class="img-circle">
                              </a>
                              <a href="#" class="clear">
                            ...
                            <li class="list-group-item">
                              <a href="#" class="thumb-sm pull-left m-r-sm">
                                <img src="${pageContext.request.contextPath }/images/a5.png" class="img-circle">
                              </a>
                              <a href="#" class="clear">
                            ...
                            <li class="list-group-item">
                              <a href="#" class="thumb-sm pull-left m-r-sm">
                                <img src="${pageContext.request.contextPath }/images/a6.png" class="img-circle">
                              </a>
                              <a href="#" class="clear">
                            ...
                            <li class="list-group-item">
                              <a href="#" class="thumb-sm pull-left m-r-sm">
                                <img src="${pageContext.request.contextPath }/images/a7.png" class="img-circle">
                              </a>
                              <a href="#" class="clear">
                            ...
                            <li class="list-group-item" href="#email-content" data-toggle="class:show">
                              <a href="#" class="thumb-sm pull-left m-r-sm">
                                <img src="${pageContext.request.contextPath }/images/a8.png" class="img-circle">
                              </a>
                              <a href="#" class="clear">
                                <small class="pull-right">3 minuts ago</small>
                                <strong class="block">Drew Wllon</strong>
                            ...
                            <li class="list-group-item">
                              <a href="#" class="thumb-sm pull-left m-r-sm">
                                <img src="${pageContext.request.contextPath }/images/a9.png" class="img-circle">
                              </a>
                              <a href="#" class="clear">
                                <small class="pull-right">1 hour ago</small>
                                <strong class="block">Jonathan George</strong>
