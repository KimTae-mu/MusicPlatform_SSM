...
<body class="">
  <section class="vbox">
    ...
    <section>
      <section class="hbox stretch">
        <!-- .aside -->
        <aside class="bg-primary nav-xs aside hidden-print" id="nav">          
          <section class="vbox">
  ...
  <script type="text/javascript" src="j${pageContext.request.contextPath }/s/jPlayer/add-on/jplayer.playlist.min.js"></script>
